        ...
        <div className="rv-ink" style={{ '--i': 1 } as React.CSSProperties}>
          ...
          <address className="not-italic">
            <a
              ...
              className="font-mono text-[15px] text-ink underline decoration-rule-strong underline-offset-[5px] transition-colors hover:text-ink"
            >
            ...
            <a
              ...
              className="font-mono text-[13px] text-ink-muted underline decoration-rule-strong underline-offset-[5px] transition-colors hover:text-ink"
            >
          ...
          {siteConfig.social.github && (
            <p className="mt-2">
              <a
                ...
                className="font-mono text-[12.5px] text-ink-muted underline decoration-rule-strong underline-offset-[5px] transition-colors hover:text-ink"
              >
                开源主页
              </a>
            </p>
